...
public class PublicKey {
    ...
    public ResponseEntity<cloud.fogbow.accounting.api.http.response.PublicKey> getPublicKey() throws UnexpectedException {
        try {
            String publicKeyValue = ApplicationFacade.getInstance().getPublicKey();
            cloud.fogbow.accounting.api.http.response.PublicKey publicKey = new cloud.fogbow.accounting.api.http.response.PublicKey(publicKeyValue);
